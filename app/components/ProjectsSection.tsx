  ...
  export default function ProjectsSection() {
    const projects = [
      ...
      { title: "SEVA - Event Management App", tech: ["Flutter", "MongoDB","NodeJS"],url : "https://seva-nss-mit-manipal.vercel.app/"},
      ...
      { title: "Save Earth Ride website", tech: ["React","NodeJS", "MongoDB"],url: "https://bikingcommunityofindia.com/"},
      { title: "Ind2b - B2B ECommerce platform", tech: ["React","NodeJS", "MongoDB"],url : "https://www.ind2b.com/"}
    ];
