            ...
            <div className="footer-inner">
                ...
                <div className="footer-brand">
                    ...
                    <p className="footer-tagline">
                        Building scalable, beautiful software — one commit at a time.
                    </p>
                </div>
                ...
                <div className="footer-socials">
                    ...
                    <a
                        href="https://www.linkedin.com/in/mohammad-tausif-3a50801a8/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="footer-social-link"
                        aria-label="LinkedIn"
                ...
                <div className="footer-bottom">
                    <span className="footer-copy">© {year} Tausif. All rights reserved.</span>
                    <a
